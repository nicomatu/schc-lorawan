...
var util = require('./devutil.js')("lora-packet parser");
var crypt =  require('./devcrypt.js')//("in-packet decryption");
...
function LoraPacket(packetContents) {
    ...
    this.toString = function() {
        ...
        if (that.isJoinRequestMessage()) {
            ...
            msg += "                  MHDR = " + asHexString(p.MHDR) + "\n";
            msg += "            MACPayload = " + asHexString(p.MACPayload) + "\n";
            msg += "                   MIC = " + asHexString(p.MIC) + " (from packet) \n";
//            msg += "                       = " + asHexString(p.MIC) + " (expected, assuming 32 bits frame counter below 65,536) \n";
            msg += "\n";
            msg += "          ( MACPayload = FHDR | FPort | FRMPayload )\n";
            msg += "                  FHDR = " + asHexString(p.FHDR) + "\n";
            msg += "                 FPort = " + asHexString(p.FPort) + "\n";
            msg += "            FRMPayload = " + asHexString(p.FRMPayload) + " (from packet, encrypted) \n";
//            msg += "                       = " + asHexString(p.FRMPayload) + " (decrypted) \n";
            msg += "\n";
